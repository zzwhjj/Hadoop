...
public class HbaseClient {
	...
	static {
		...
		configuration.set("hbase.zookeeper.quorum", "192.168.31.130");
		configuration.set("hbase.master", "192.168.31.130:600000");
	}*/
	...
	public static void insertData(String tableName) {
		...
		HTablePool pool = new HTablePool(hbconf, 1000);
